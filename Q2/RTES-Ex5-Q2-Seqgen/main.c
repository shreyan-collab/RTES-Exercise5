...
TaskHandle_t                xHandle1 = NULL, xHandle2 = NULL, xHandle3 = NULL,
                            ...
                            xHandle7 = NULL;
uint32_t ui32Period, count_33ms = 0, ui32SysClkFreq;
...
init_peripherals()
{
    ...
    ui32Period = (ui32SysClkFreq / 30); //timer will go off every 33.33msec
...
void Timer0IntHandler(void)
{
    ...
    if ((count_33ms % 10) == 0) //3 hz
    {
        s1++;
        xSemaphoreGive(semS1);
    }
    if ((count_33ms % 30) == 0) //1 hz
    {
        s2++;
