...
TaskHandle_t                xHandle1 = NULL, xHandle2 = NULL, xHandle3 = NULL,
                            ...
                            xHandle7 = NULL;
uint32_t ui32Period, count_17ms = 0, ui32SysClkFreq;
uint32_t idx = 0, jdx = 1;
uint32_t fib = 0, fib0 = 0, fib1 = 1;
QueueHandle_t queue1 = NULL;
uint32_t    wcets1[900], wcets2[900], wcets3[900],
            wcets4[900], wcets5[900], wcets6[900], wcets7[900];
...
init_peripherals()
{
    ...
    ui32Period = (ui32SysClkFreq / 60); //timer will go off every 33.33msec
...
void Timer0IntHandler(void)
{
    ...
    if ((count_17ms % 2) == 0) //30 hz
    {
        s1++;
        xSemaphoreGive(semS1);
    }
    if ((count_17ms % 6) == 0) //10 hz
    {
        s2++;
